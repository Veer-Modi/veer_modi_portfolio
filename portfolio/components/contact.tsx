...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // form.append("from_name", "Veer Portfolio Contact");
      // form.append("replyto", formData.email); // helps email clients set reply-to
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-medium">Email</p>
                      {/* Gmail compose link (opens in new tab) */}
                      <a
                        href="https://mail.google.com/mail/?view=cm&fs=1&to=veer.modi.cg@gmail.com"
                        target="_blank"
                      ...
                      {/* If you also want default email client support, add another small link:
                      <div>
                        <a href="mailto:veer.modi.cg@gmail.com" className="text-xs underline">
                          or open default mail app
                        </a>
                      </div>
                      */}
                    </div>
